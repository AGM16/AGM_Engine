...
{
	//Move Buttons-----------------------------------------------------------
	float3 pos = camera_component->Get_Component_Transformation_Camera()->Get_Position();
	...
	camera_component->Get_Component_Transformation_Camera()->Set_Position(pos);
...
// -----------------------------------------------------------------
void ModuleCamera3D::Set_Position(const vec &Movement)
{
	camera_component->Get_Component_Transformation_Camera()->Set_Position(Movement);
}
